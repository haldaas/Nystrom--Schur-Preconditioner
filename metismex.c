...
*
* To compile, you need to have Metis 4, modify the path to include mex and
* matrix from Matlab (lines 38--39), and do something like
...
// Modify the two lines below to match the path on your system
#include "/Applications/MATLAB_R2021b.app/extern/include/mex.h"
#include "/Applications/MATLAB_R2021b.app/extern/include/matrix.h"
//
#include <strings.h>
#include "metis.h"
